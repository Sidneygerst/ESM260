...
young_density$density_youngfish_100m <- young_density$microhabitat_100m/young_density$densityfish_100m
...
Rsqrd <- adult_young_merge %>% 
  group_by(organism ) %>% 
  summarize(R2 = summary(lm(density_youngfish_100m ~ density))$r.squared)

Rsqrd <- mutate(Rsqrd, x = 10.5, y = 100, Label = paste("R^2=", round(R2, 4)))
